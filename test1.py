...
# creating the database and connecting with it
db_name = "iNeuron"
db = client[db_name]

# creating a collection
collection_name = "iNeuron_students"
...
# creating multiple records (JSON)
list_of_records = [
    {'companyName': 'iNeuron',
